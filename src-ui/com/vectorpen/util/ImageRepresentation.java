...
public class ImageRepresentation {
    ...
    public static BufferedImage overlayImageRepresentationByHeight(BufferedImage img, VectorFile file, int height)
	{
    ...
    public static BufferedImage overlayImageRepresentationByWidth(BufferedImage img, VectorFile file, int width)
	{
		Size paperSize = file.getPaperSize(72);
